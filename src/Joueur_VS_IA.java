...
public class Joueur_VS_IA {
    ...
    public static void boucleDeJeuJoueurVSOrdi() throws InterruptedException {
        ...
        while (enCours) {
            ...
            if (aucunCoupPossible()) {
                System.out.println("\nAucun coup n'est possible pour Noir et/ou Blanc !");
                enCours = false;
                break;
            }

            if (!peutJouer(joueur)) {
                System.out.println("\nLe joueur " + joueur + " ne peut pas jouer et passe son tour !");
                joueur = (joueur == 'B') ? 'N' : 'B';
    ...
    public static void jouerOrdinateur() throws InterruptedException {
        System.out.println("\nL'ordinateur joue...");
